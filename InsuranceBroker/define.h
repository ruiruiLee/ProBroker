...
//#define SMS_SERVER_ADDRESS @"http://h5.ukuaibao.com"
...
#define Peivate_Msg_Url @"%@/news/privateLetter/details?acceptId=%@&senderId=%@"
...
#define CAR_INSUR_PLAN @"%@?customerCarId=%@&appId=%@&orderUuId=%@&helpInsure=1"
#define RE_CAR_INSUR_PLAN @"%@?carNo=%@&appId=%@&orderUuId=%@&helpInsure=1"
...
#define kShenHeBeiAn      0
#define kAccount   @"13880415678"
#define kPassword  @"777776"

//正式服
#define youKeUUId @"dWtiampy_5be2e91bb6df4a2d8420d7c14c1df3bd"
#define youKeUserId @"6904"
#define youKeMoShi ([[UserInfoModel shareUserInfoModel].userId isEqualToString:youKeUserId] ? 1 : 0)
