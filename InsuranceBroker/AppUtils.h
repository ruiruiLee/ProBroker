...
//////////////////////////微信//////////////////////////////
#define WeChatAppID             @"wx4d5be0425a7a8af0"
#define WeChatAppSecret         @"963a4be41493c18c5917d285a1c55d0b"
//商户号，填写商户对应参数
#define WeChatMCH_ID                  @"1363947802"
//商户API密钥，填写相应参数
#define WeChatPARTNER_ID              @"4a397d7ea5954574ace20307fabf7bcf"
//支付结果回调页面
#define WeChatNOTIFY_URL              @"http://broker.ukuaibao.com/web/pay/notifyInsurancePay.xhtml"
