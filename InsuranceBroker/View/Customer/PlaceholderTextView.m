...
- (void)awakeFromNib {
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-2-[PlaceholderLabel(30)]->=0-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(PlaceholderLabel)]];
